...
#define MUDLIB_NAME                             "MHSJ-SS"
#define MUDLIB_VERSION_NUMBER	"1.2"
#define MUDLIB_VERSION			(MUDLIB_NAME + " " + MUDLIB_VERSION_NUMBER)
#define HOTSADDRESS                    "localhost"
#define INTERMUD_MUD_NAME               "MHSJ-SS"
#define INTERMUD_NAME                   "魔幻世纪沙市站"
#define CHINESE_MUD_NAME                "魔幻世纪沙市站"
#define MUD_ADMIN                       "mhsj_xyj@etang.com"
#define MUD_WEB                           "http://qdmud.com"
