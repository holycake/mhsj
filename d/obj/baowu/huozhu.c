...
void create()
{
        set_name(HIR "火灵珠" NOR, ({"huo lingzhu","lingzhu","zhu","huozhu"}) );
        set_weight(200);
        if( clonep() )
...
void announce(object who)
{
    ...
    CHANNEL_D->do_channel(this_object(), "rumor", 
	    this_player()->name()+HIM"在"NOR+HIW+
...
void init()
{
    	 ...
    	 call_out("announce",random(3),this_player());
...
又待片刻，五珠呼的一暗，$N手中却多了一颗硕大的透明宝珠，不时发出五彩毫光。\n",who);
         ...
         if ("/d/obj/baowu/shengzhu"->in_mud())
        //shengzhu = new("/d/obj/baowu/shengzhu1");
