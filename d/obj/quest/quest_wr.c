...
mapping quests_wearing = ([
    ...
    2100 : ({ "find", "桂花",      "gui hua",            "", "1" }),
    2200 : ({ "find", "野菊花",    "ju hua",             "", "1" }),
    2300 : ({ "find", "矢车菊",    "ju hua",             "", "1" }),
    2400 : ({ "find", "白菊花",    "ju hua",             "", "1" }),
    2500 : ({ "find", "蔷薇花",    "rose",               "", "1" }),
    ...
    5000 : ({ "find", "蓝玫瑰",    "flower",             "", "1" }),
    5100 : ({ "find", "黑郁金香",  "flower",             "", "1" }),
    5150 : ({ "find", "薄雪花",    "flower",             "", "1" }),
    5200 : ({ "find", "玉白露",    "flower",             "", "1" }),
    5250 : ({ "find", "野风信子",  "flower",             "", "1" }),
    5300 : ({ "find", "睡芙蓉",    "flower",             "", "1" }),
    5350 : ({ "find", "紫蔷薇",    "flower",             "", "1" }),
    5400 : ({ "find", "大丽花",    "flower",             "", "1" }),
    5450 : ({ "find", "勿忘我",    "flower",             "", "1" }),
    5500 : ({ "find", "白玫瑰",    "flower",             "", "1" }),
    5550 : ({ "find", "翡翠绿",    "flower",             "", "1" }),
    5600 : ({ "find", "雪腊梅",    "flower",             "", "1" }),
    5650 : ({ "find", "曼陀罗",    "flower",             "", "1" }),
    5700 : ({ "find", "睡莲",      "flower",             "", "1" }),
    ...
    9000 : ({ "find", "蓝色小草",  "xiao cao",           "", "1" }),
   10000 : ({ "find", "玉佩",            "yu pei",             "", "1" }),
   20000 : ({ "find", "冰露珠项链" , "icedew lace",     "", "1" }),
   50000 : ({ "find", "银簪",    "clasp",              "", "1" }),
   80000 : ({ "find", "珍珠",            "pearl",              "", "1" }),
  310000 : ({ "find", "白鹿头",          "bai lutou",          "", "1" }),
  320000 : ({ "find", "灰羊角",          "hui yangjiao",       "", "1" }),
  500000 : ({ "find", "佛宝舍利子","tooth",              "", "1" }),
