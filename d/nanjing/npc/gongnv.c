...
void create()
{
	...
	ids+=({ "gongnv", "gonge" });
	set_name(name(),ids);
	set("long", "她是经过皇家音容、体态重重选拔的良家女子，她是名宫廷侍女。\n");
	set("title", MAG"宫娥"NOR);
...
*/
	setup();
	carry_object("/d/nanjing/obj/mao_gong")->wear();
	carry_object("/d/nanjing/obj/cloth_gong")->wear();
	carry_object("/d/nanjing/obj/skirt_gong")->wear();
