...
{
	seteuid(getuid());
	set_name("杨嗣昌", ({ "yang sichang", "yang", "sichang", "daxueshi", "gelao" }));
	set("long", "湖南武陵人，字文弱，号字微。礼部尚书兼东阁大学士，入参机务，仍掌兵部事。\n");
	set("title", RED"礼部尚书兼东阁大学士"NOR);
	set("degree", RED "正二品 资政大夫正治卿" NOR);
	set("gender", "男性");
	set("age", 50);
	set("per", 28);
	set("level", 8);
