...
[41m  [1;33m承办各式酒席, 欢迎惠顾： [2;37;0m
        ...
        [1;31morder birthday: 祝寿宴        ([2;37;0m[33m2两[1;33m黄金[1;31m)[2;37;0m

        [1;31morder marry:    订婚宴        ([2;37;0m[33m3两[1;33m黄金[1;31m)[2;37;0m

        [1;31morder player:   群豪宴        ([2;37;0m[33m5两[1;33m黄金[1;31m)[2;37;0m
...
int do_broadcast(string arg)
{
        ...
        if (type == "marry") {
                mesg = me->name() + "现在在喜福会芙蓉厅举行订婚酒宴了  !!!\n";
        } else if (type == "birthday") {
                mesg = me->name() + "现在在喜福会芙蓉厅举行生辰寿宴了  !!!\n";
        } else if (type == "player") {
                mesg = me->name() + "现在在喜福会芙蓉厅宴请各路英雄豪杰  !!!\n";
       }
...
int do_order(string arg)
{
        ...
        if (arg == "marry") {
                mesg = me->name() + "现在在"HIR"喜福会"HIY"芙蓉厅举行订婚酒宴了  !!!\n";
                ...
                mesg = me->name() + "现在在"HIR"喜福会"HIY"芙蓉厅举行生辰寿宴了  !!!\n";
                ...
                mesg = me->name() + "现在在"HIR"喜福会"HIY"芙蓉厅宴请各路英雄豪杰  !!!\n";
