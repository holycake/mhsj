...
void reset_me (object me)
{
	...
	me->set("gender", "男性" );
	me->set("title",YEL+me->query("family/family_name")+NOR+zname(me));
	me->set("short",HIY+me->query("name")+NOR+"("+HIY+capitalize(me->query("id"))+NOR+")");
...
int convert_identity (object me, object ob)
{
	...
	me->set("title",YEL+ob->query("family/family_name")+NOR+zname(ob));
	ob->save();
...
int rank_me()
{
	...
	exp=(int)me->query("combat_exp");
        if( me->query("title") == YEL"食天鼠王"NOR)
