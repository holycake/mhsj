...
void reset_me (object me)
{
	...
	me->set("gender", "男性" );
	me->set("title",BLU+me->query("family/family_name")+NOR+zname(me));
	me->set("short",HIB+me->query("name")+NOR+"("+HIY+capitalize(me->query("id"))+NOR+")");
...
int convert_identity (object me, object ob)
{
	...
	ob->set("zhangmen/title_old",ob->query("title"));
       ob->set("zhangmen/title",BLU+ob->query("family/family_name")+zname(ob)+NOR);
	ob->set("title",BLU+ob->query("family/family_name")+NOR+zname(ob));
	ob->save();
	...
	me->set("title",BLU+ob->query("family/family_name")+NOR+zname(ob));
	me->set("short",HIB+me->query("name")+NOR+"("+HIY+capitalize(me->query("id"))+NOR+")");
...
int init_identity (object me, object master, object where)
{
	...
	me->set("title",BLU+me->query("family/family_name")+NOR+zname(me));
	me->set("short",HIB+me->query("name")+"("+HIY+capitalize(me->query("id"))+NOR+")");
...
int rank_me()
{
	...
	exp=(int)me->query("combat_exp");
        if( me->query("title") == BLU"大罗真仙"NOR)
	...
	if( me->query("family/family_name") == "五庄观")
	{
			...
			me->set("title", BLU"五庄观八卦真仙"NOR);
		} else {
			me->set("title", BLU"五庄观真武道尊"NOR);
		}
