...
int main(object me, string arg)
{
        ...
        if( map_to=="none" ) {
          ...
          if( this_player()->query("combat_exp") <100000 && !wizardp(this_player())){
        if( ski=="magic" ) {
