...
int main(object me,string arg, string blk)
{
	int i;
	string newarg, str1, str2,str3;
	...
	return 1;
            ...
            if( arg=="blink" ) { str3 = me->query("nickname");
	me->set("nickname", BLINK + str3 + NOR); 
            write("NICKBLINK 完成。\n");
          	return 1;
	}
