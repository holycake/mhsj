...
{
        if( new_email != ""&&strwidth(new_email) < 50)
...
{
        if( new_webpage != ""&&strwidth(new_webpage) < 300)
...
{
        if( new_icq != ""&&strwidth(new_icq) < 10)
